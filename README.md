...
3. Отправьте участникам одну публичную ссылку и нажмите «Начать оценку».
4. После достижения минимума раскройте карты. При необходимости запустите повторный раунд.
5. Нажмите «Сохранить и перейти к следующей» — следующая задача из очереди откроется автоматически.
