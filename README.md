...
5. На последней задаче участник нажимает «Завершить оценку» и видит подтверждение, что ответы сохранены.
6. Организатор видит прогресс по каждой задаче. После достижения минимума он раскрывает карты и сохраняет точную среднюю оценку.
